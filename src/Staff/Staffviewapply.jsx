...
<div class="relative overflow-x-auto justify-center flex">
    ...
    <Link to='/staff/staffviewapplydetail'><a href="#" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Apllication for ownership certificate</a></Link>
                </th>
               <td>pending</td> 
