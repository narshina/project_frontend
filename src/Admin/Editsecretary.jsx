...
export const Editsecretary = () => {
  ...
  let handlesubmit = (event) => {
    ...
    const requiredFields = ['name', 'photo', 'age', 'gender', 'email', 'qualification', 'house', 'street', 'district', 'pincode', 'phone number', 'password'];
    console.log(data);
        ...
        <div className="flex gap-8" >
          <div className=' h-[360px] w-[450px]  ml-60 '>
            ...
            <div className='text h-9   text-white mt-4 flex' onClick={handleUploadFile}>
              ...
              <input onChange={handlechange} ref={fileUpload} type="file" className='hidden h-9 w-56 bg-white rounded-r-lg ' name='photo' />
              <div className="">
            ...
            <div className='text h-9   text-white mt-4 flex'>
              ...
              <input onChange={handlechange} className='text-black  h-9 w-56 bg-white rounded-r-lg' name='qualification' type='text'></input></div>
          ...
          <div className=' h-[360px] w-[450px]  '>
            <div className='text h-9   text-white mt-4 flex'>
              ...
              <input onChange={handlechange} className='text-black  h-9 w-56 bg-white rounded-r-lg' name='house' type='text'></input>
            </div>
            <div className='text h-9   text-white mt-4 flex'>
              <span className='bg-[#0F3053] w-56  rounded-l-lg pl-5'>
                STREET:
