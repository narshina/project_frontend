...
export const Viewstaff = () => {
  return (
    <div className=' w-screen h-[655px] bg-[#CCDAF6]  pt-5 content-center' >
     <div className='ml-[650px] font-serif text-[20px] font-bold'><h2>STAFF MANAGEMENT</h2></div>   
    ...
    <table class="w-[850PX] text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 mt-5">
        ...
        <tbody>
            <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
              ...
              <Link to='/admin/viewstaffdetail'> <a href="#" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">View</a></Link>
