...
<div className='w-[100%] h-[695px] bg-[#CCDAF6] flex justify-center'>
    <div className='h-[450px] w-[450px]  mt-7 ' >
        ...
        <input className='h-9 w-96 border-black bg-white rounded-xl'/></div>
        <div><a className='text-black'>COMPLAINT:</a>
        <input className='h-24 w-96 border-black bg-white rounded-xl'/></div>
        <div><button className='h-9 w-96 bg-[#0F3053] mt-5 text-white rounded-xl' >SUBMIT</button></div>
    </div>
</div>
