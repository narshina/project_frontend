  ...
  return (
    ...
    <div className=' w-[30%] p-8  mt-2 bg-[#617DB2] m-auto rounded-2xl' >
      ...
      <div> <div className='text-black'>Card holder:</div>
        ...
        <select className='h-9  w-36 bg-white rounded-xl text-black'  name="" id="">
        ...
        <input className='h-9 w-[100%] border-black bg-white rounded-xl'/></div>
        <div><button className='pt-4 pb-4 w-[100%] bg-[#0F3053] mt-5 text-white rounded-lg' >pay now</button></div>
    </div>
</div>
  )
}
